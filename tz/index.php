...
include '//cdn.eees.cn/tz/txprotect.php';
$target = 'http://eees.cn';
...
<title>站点提示</title>
    ...
    <link href="https://cdn.eees.cn/tz/css/index.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="//cdn.eees.cn/js/jquery.min.js"></script>
...
<body style="background-color: #f5f5f5;">
    <div id="Pan_WX">
        <!--微信访问-->
        <div class="fc_jt">
            <img src="//cdn.eees.cn/tz/img/jt.png"></div>
               <div class="fc_wz">
                点击屏幕右上角【...】<br />
                使用【浏览器】打开
            </div>  
          <div class="fc_tp">
            <img src="//cdn.eees.cn/tz/img/qq.png"></div>
        </div>
</body>
</html>
<?php
...
<body style="background-color: #f5f5f5;">
    <div id="Pan_WX">
        ...
        <div class="fc_jt">
          ...
          <div class="fc_tp">
            <img src="//cdn.eees.cn/tz/img/wx_az.png"></div>
		</div>
</body>
</html>
<?php
